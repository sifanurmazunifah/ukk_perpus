...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 05, 2025 at 11:05 AM
...
INSERT INTO `buku` (`id_buku`, `sampul`, `judul`, `penulis`, `penerbit`, `tahun_terbit`) VALUES
(2, '', 'legends of the blue sea', 'sifa', 'sifa', 2006),
(6, '', 'legenda si kancil', 'saka', 'saka', 1964),
(14, '', 'mermaid', 'sara', 'sara', 1944),
(15, '', 'dracin', 'lili', 'lili', 2007),
(16, '', 'seri', 'sifa', 'sifa', 1904);
...
(1, 'user', 'pass', 'a@b.com', 'Sifa Nur', 'kjrn', 'administrator'),
(5, 'us', 'pas', 'ci@gm.com', 'cici', 'bd', 'administrator'),
(6, 'username', 'password', 's@gmail.com', 'sasya', 'klk', 'administrator'),
(7, 'user', 'pass', 'a@gmail.com', 'ana', 'kota', 'administrator'),
(8, 'uss', 'pass', 'n@gmail.com', 'nikita', 'kediri', 'administrator'),
(9, 'username', 'password1', 'ci@gm.com', 'saya', 'mm', 'administrator');
...
--
ALTER TABLE `koleksipribadi`
  MODIFY `id_koleksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
